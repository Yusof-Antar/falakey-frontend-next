...
const localizedContent = {
  en: {
    ...
    keywords:
      "free photos, stock images, vectors, Arab digital creativity, photography challenges, Falakey, download photos",
  },
  ar: {
    ...
    image: "/icons/star-icon.svg",
    keywords:
      "صور مجانية, فيكتور, تصوير إبداعي, منصة عربية, فلكي, تحميل صور, تصميم عربي",
  },
};
